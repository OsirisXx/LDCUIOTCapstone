...
1. AUTHENTICATIONMETHODS → USERS (Many-to-One)
   ...
   Figure 1. USERS has one and only one to one to many AUTHENTICATIONMETHODS
...
2. SUBJECTS → USERS (Many-to-One)
   ...
   Figure 2. USERS has one and only one to one to many SUBJECTS
...
3. CLASSSCHEDULES → SUBJECTS (Many-to-One)
   ...
   Figure 3. SUBJECTS has one and only one to one to many CLASSSCHEDULES
...
4. CLASSSCHEDULES → ROOMS (Many-to-One)
   ...
   Figure 4. ROOMS has one and only one to one to many CLASSSCHEDULES
...
5. SUBJECTENROLLMENT → USERS (Many-to-One)
   ...
   Figure 5. USERS has one and only one to one to many SUBJECTENROLLMENT
...
6. SUBJECTENROLLMENT → SUBJECTS (Many-to-One)
   ...
   Figure 6. SUBJECTS has one and only one to one to many SUBJECTENROLLMENT
...
7. SESSIONS → CLASSSCHEDULES (Many-to-One)
   ...
   Figure 7. CLASSSCHEDULES has one and only one to one to many SESSIONS
...
8. SESSIONS → USERS (Many-to-One)
   ...
   Figure 8. USERS has one and only one to one to many SESSIONS

9. SESSIONS → ROOMS (Many-to-One)
   SESSIONS.ROOMID → ROOMS.ROOMID, ON DELETE CASCADE
   Meaning: One room can host multiple sessions
   Figure 9. ROOMS has one and only one to one to many SESSIONS
...
10. ATTENDANCERECORDS → USERS (Many-to-One)
    ...
    Figure 10. USERS has one and only one to one to many ATTENDANCERECORDS
...
11. ATTENDANCERECORDS → CLASSSCHEDULES (Many-to-One)
    ...
    Figure 11. CLASSSCHEDULES has one and only one to one to many ATTENDANCERECORDS
...
12. ATTENDANCERECORDS → SESSIONS (Many-to-One)
    ...
    Figure 12. SESSIONS has one and only one to one to many ATTENDANCERECORDS
...
13. ACCESSLOGS → USERS (Many-to-One)
    ...
    Figure 13. USERS has one and only one to one to many ACCESSLOGS
...
14. ACCESSLOGS → ROOMS (Many-to-One)
    ...
    Figure 14. ROOMS has one and only one to one to many ACCESSLOGS

15. DEVICES → ROOMS (Many-to-One)
    DEVICES.ROOMID → ROOMS.ROOMID, ON DELETE CASCADE
    Meaning: One room can have multiple devices
    Figure 15. ROOMS has one and only one to one to many DEVICES
```
